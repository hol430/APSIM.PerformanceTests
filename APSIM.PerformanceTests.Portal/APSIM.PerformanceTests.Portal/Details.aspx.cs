    ...
    public partial class Details : System.Web.UI.Page
    {
        ...
        protected void gvPOTests_Sorting(object sender, GridViewSortEventArgs e)
        {
            ...
            if (POTestsDT != null)
            {
                ...
                foreach (DataControlFieldHeaderCell headerCell in gvPOTests.HeaderRow.Cells)
                {
                    ...
                    {
                        case "Variable":
                            gvPOTests.Columns[0].HeaderText = "Variable";
                            break;
                        case "Test":
                            gvPOTests.Columns[1].HeaderText = "Test";
                            break;
                        case "Accepted":
                            gvPOTests.Columns[2].HeaderText = "Accepted";
                            break;
                        case "Current":
                            gvPOTests.Columns[3].HeaderText = "Current";
                            break;
                        case "Difference":
                            gvPOTests.Columns[4].HeaderText = "Difference";
                            break;
                        case "DifferencePercent":
                            gvPOTests.Columns[5].HeaderText = "Difference<br />Percent";
                            break;
                        case "PassedTest":
                            gvPOTests.Columns[6].HeaderText = "Passed<br />Test";
                            break;
                        case "IsImprovement":
                            gvPOTests.Columns[7].HeaderText = "Is<br />Improvement";
                            break;
                    }
        ...
        protected void gvPOTests_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (e.Row.Cells[6].Text.Trim().ToLower() == "false")
                {
                    e.Row.ForeColor = Color.Red;
                }
                //this is the true/false IsImprovement column
                if (e.Row.Cells[7].Text.Trim().ToLower() == "true")
                {
        ...
        protected void gvPOValues_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if ((e.Row.Cells[1].Text.Trim() != "&nbsp;") && (e.Row.Cells[3].Text.Trim() != "&nbsp;"))
                {
                    if ((e.Row.Cells[1].Text.Trim().Length > 0) && (e.Row.Cells[3].Text.Trim().Length > 0))
                    {
                        if ((Double?)Convert.ToDouble(e.Row.Cells[1].Text.Trim()) != (Double?)Convert.ToDouble(e.Row.Cells[3].Text.Trim()))
                        {
                            //e.Row.ForeColor = Color.Red;
                ...
                if ((e.Row.Cells[2].Text.Trim() != "&nbsp;") && (e.Row.Cells[4].Text.Trim() != "&nbsp;"))
                {
                    if ((e.Row.Cells[2].Text.Trim().Length > 0) && (e.Row.Cells[4].Text.Trim().Length > 0))
                    {
                        if ((Double?)Convert.ToDouble(e.Row.Cells[2].Text.Trim()) != (Double?)Convert.ToDouble(e.Row.Cells[4].Text.Trim()))
                        {
                            //e.Row.ForeColor = Color.Red;
                            e.Row.Cells[0].ForeColor = Color.Red;
        ...
        protected void gvPOValues_Sorting(object sender, GridViewSortEventArgs e)
        {
            ...
            if (POValuesDT != null)
            {
                ...
                foreach (DataControlFieldHeaderCell headerCell in gvPOValues.HeaderRow.Cells)
                {
                    ...
                    {
                        case "SimulationName":
                            gvPOValues.Columns[0].HeaderText = "SimulationName";
                            break;
                        case "CurrentPredictedValue":
                            gvPOValues.Columns[1].HeaderText = "Current<br />Predicted<br />Value";
                            break;
                        case "CurrentObservedValue":
                            gvPOValues.Columns[2].HeaderText = "Current<br />Observed<br />Value";
                            break;
                        case "AcceptedPredictedValue":
                            gvPOValues.Columns[3].HeaderText = "Accepted<br />Predicted<br />Value";
                            break;
                        case "AcceptedObservedValue":
                            gvPOValues.Columns[4].HeaderText = "Accepted<br />Observed<br />Value";
                            break;
                        case "TableName":
                            gvPOValues.Columns[5].HeaderText = "TableName";
                            break;
                        case "MatchNames":
                            gvPOValues.Columns[6].HeaderText = "MatchNames";
                            break;
                        case "MatchValues":
                            gvPOValues.Columns[7].HeaderText = "MatchValues";
                            break;
                    }
                    //get the index and details for the column we are sorting
                    if (headerCell.ContainingField.SortExpression == e.SortExpression)
