...
namespace APSIM.PerformanceTests.Tests
{
    ...
    public class ApsimFilesControllerTests
    {
        ...
        /// <summary>
        /// This tests an insert of a partially-full version wheat predicted/observed data,
        /// with a snapshot of the live data (as of 2020-05-28) from the production DB.
        /// </summary>
        [Test]
